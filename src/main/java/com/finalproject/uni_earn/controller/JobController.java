...
import com.finalproject.uni_earn.service.impl.JobStatusScheduler;
...
public class JobController {
    ...
    ResponseEntity<StandardResponse> searchJobs(
            ...
            @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") Date startDateFrom,
            @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") Date startDateTo,
        ...
        PaginatedResponseJobDTO jobList = jobService.searchJobs(location, categoryList, keyword, startDateFrom, startDateTo , page);
        return new ResponseEntity<StandardResponse>(
                new StandardResponse(200, "Success", jobList),
                HttpStatus.OK);
    }
